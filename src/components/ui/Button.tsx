...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variantClasses = {
    primary: "bg-yellow-400 text-slate-950 hover:bg-yellow-300 shadow-xl shadow-yellow-400/20",
    dark: "bg-slate-900 text-white hover:bg-slate-800 border border-white/5",
    outline: "bg-transparent border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400/5",
